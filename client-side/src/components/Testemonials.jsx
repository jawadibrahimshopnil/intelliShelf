	...
	<div className="container grid grid-cols-1 gap-8 mx-auto lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
		<div className="flex flex-col items-center mx-12 lg:mx-0">
			<div className="relative text-center">
				...
				<p className="px-6 py-1 text-lg italic">As a librarian, I have seen my fair share of library management systems, but none have impressed me as much as this one. It has intuitive, efficient, and has all the features we need to keep our library organized. Thanks for such a fantastic tool!</p>
			...
			<span className="w-12 h-1 my-2 rounded-lg dark:bg-default-600"></span>
			<p>Leroy Jenkins</p>
		</div>
		<div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
			<div className="relative text-center">
				...
				<p className="px-6 py-1 text-lg italic">I have been using this library management system for months now, and it has been a game-changer for our school. The user-friendly interface and extensive book collection have made managing our library a breeze. Highly recommend!</p>
